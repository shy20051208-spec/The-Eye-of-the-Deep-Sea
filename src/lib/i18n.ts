...
export const messages = {
  en: {
    ...
    dataManagement: {
      ...
      search: "Search stations, sea areas...",
    ...
    visualization: {
      ...
      sparkline: "Sparkline",
      charts: {
        depthTemp: "Depth-Temperature Profile",
        tsPlot: "T-S Diagram",
        depthSalinity: "Depth-Salinity Profile",
        depthDensity: "Depth-Density Profile",
  ...
  zh: {
    ...
    visualization: {
      ...
      charts: {
        depthTemp: "深度-温度剖面",
        tsPlot: "T-S 图",
        depthSalinity: "深度-盐度剖面",
        depthDensity: "深度-密度剖面",
